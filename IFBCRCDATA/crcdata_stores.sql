...
CREATE TABLE `stores` (
  `Order_PickupStore` int(11) NOT NULL,
  `Pickup_Store_Name` varchar(255) DEFAULT NULL,
  `Pickup_Store_Address` varchar(255) DEFAULT NULL,
  `Pickup_Store_Phone` varchar(255) DEFAULT NULL,
  `Pickup_Store_City` char(255) DEFAULT NULL,
  `Pickup_Store_State_Name` char(16) DEFAULT NULL,
  PRIMARY KEY (`Order_PickupStore`)
...
-- Dump completed on 2018-09-18 11:05:20
